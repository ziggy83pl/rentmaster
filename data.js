const listingsData = [
    ...
    },
    {
        ...
        params: [
            { icon: 'fa-expand', text: '500m²' },
            { icon: 'fa-layer-group', text: 'Utwardzona' }
        ],
        price: { value: 800, unit: '/mc' },
    ...
    },
    {
        ...
        params: [
            { icon: 'fa-expand', text: '48m²' },
            { icon: 'fa-bed', text: '2 Pokoje' }
        ],
        price: { value: 1800, unit: '/mc' },
